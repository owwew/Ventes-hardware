...
class AdController extends AbstractController
{
     ...
     * @Security("is_granted('ROLE_USER') and user === ad.getAuthor()", message="Vous n'etes pas le proprietaire de cette annonce ! ")
     * @return Response
     */
    public function edit(Ad $ad, Request $request, ObjectManager $manager){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash(
                'success',
                "Les modification de l'annonce <strong>{$ad->getTitle()}</strong> a bien été enregistré !"
            );
