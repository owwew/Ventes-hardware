    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                'coverImage', 
                UrlType::class, 
                $this->getConfiguration("Url de l'image","Donnez un url de l'image ")
            )
            ->add(
                'introduction', 
                TextType::class, 
            ...
            ->add(
                'content', 
                TextareaType::class, 
                $this->getConfiguration("Description détaillée","Tapez une déscription qui donne envie de venir chez vous ")
            )
            ->add(
                'price', 
                MoneyType::class, 
